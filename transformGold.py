...
def readDataSilver(year,place,quali):
    ...
    arquivo = caminho1 / f'dados_telemetry_silver_{place}_{year}.parquet'
    arquivo2 = caminho2 / f'dados_voltas_silver_{place}_{year}.parquet'
...
def savingGold(stage,year,place,quali):
    caminho3 = Path(__file__).parent / f'{stage}' /  f'year={year}'/f'place={place}'/f'quali={quali}'
